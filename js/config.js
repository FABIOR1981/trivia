...
export const TIEMPO_MOSTRAR_PREGUNTA = 15000;
export const TIEMPO_MOSTRAR_RESPUESTA = 6000;
export const TIEMPO_CUENTA_ATRAS = 15; // Duración de la cuenta regresiva en segundos
